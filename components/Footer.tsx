          ...
          <div className="lg:col-span-4">
            ...
            <ul className="space-y-3 mb-6">
              ...
              <li className="flex items-start space-x-3">
                ...
                <div>
                  <span className="text-white font-body text-base block">Corporate Office: Dubai, UAE</span>
                  <span className="text-white font-body text-base block">Plant: Ras Al Khaimah, UAE</span>
                </div>
              </li>
            </ul>
