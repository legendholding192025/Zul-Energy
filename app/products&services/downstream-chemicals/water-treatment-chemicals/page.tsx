    ...
    <main className="overflow-x-hidden">
      ...
      <section id="home" className="relative bg-gradient-to-r from-zul-green to-primary-900 text-white mt-24" style={{ height: '672.25px' }}>
        ...
        <div 
          ...
          style={{
            backgroundImage: 'url("https://cdn.legendholding.com/images/cdn_68b93a9f717643.75016161_20250904_070711.webp")'
          }}
        >
        </div>
        {/* Content Overlay */}
      ...
      <section id="contact" className="bg-gray-50">
        <ContactUs preSelectedProduct="water-treatment-chemicals-downstream" />
      </section>
