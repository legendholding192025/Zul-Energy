          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-left">
              <h1 className="font-headline text-white mb-8 leading-tight">
                STIMULATION CHEMICALS<br />
                MAXIMIZE PRODUCTION<br />
                AND ENHANCE WELL<br />
                PERFORMANCE
              </h1>
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="w-80 h-80 bg-gradient-to-br from-yellow-100 to-yellow-200 rounded-lg flex items-center justify-center">
                <span className="text-zul-grey-dark text-lg">Stimulation Chemicals Image</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 rounded-lg p-6 text-center">
              ...
              <p className="text-zul-grey-dark text-sm">Advanced stimulation solutions for drilling operations</p>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-6 text-center">
              ...
              <p className="text-zul-grey-dark text-sm">Comprehensive stimulation support and expertise</p>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-6 text-center">
              ...
              <p className="text-zul-grey-dark text-sm">Production enhancement and optimization</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="font-body text-zul-grey-dark mb-6 leading-relaxed">
                High-performance stimulation chemicals designed to maximize hydrocarbon production 
                and enhance well performance. Our formulations provide effective acidizing, 
                fracturing, and production enhancement solutions for various reservoir conditions.
              </p>
              
              <div className="space-y-4">
                <div className="flex items-start">
                  <div className="w-2 h-2 bg-zul-yellow rounded-full mt-2 mr-3"></div>
                  <p className="text-zul-grey-dark">Enhanced production rates and recovery</p>
                </div>
                <div className="flex items-start">
                  <div className="w-2 h-2 bg-zul-yellow rounded-full mt-2 mr-3"></div>
                  <p className="text-zul-grey-dark">Effective reservoir stimulation</p>
                </div>
                <div className="flex items-start">
                  <div className="w-2 h-2 bg-zul-yellow rounded-full mt-2 mr-3"></div>
                  <p className="text-zul-grey-dark">Optimized chemical performance</p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-zul-grey-dark text-sm">Well stimulation and enhancement</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-zul-grey-dark text-sm">Deepwater stimulation operations</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-zul-grey-dark text-sm">Extended reach well stimulation</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-zul-grey-dark text-sm">Unconventional formation stimulation</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-zul-green">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-headline text-white mb-6">
            Ready to Maximize Your Production?
          </h2>
          <p className="font-body text-white mb-8 max-w-2xl mx-auto">
            Get expert consultation and customized stimulation chemicals for enhanced well performance and production optimization.
          </p>
