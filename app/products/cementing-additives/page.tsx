          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-left">
              <h1 className="font-headline text-white mb-8 leading-tight">
                CEMENTING ADDITIVES<br />
                SUPERIOR WELL INTEGRITY<br />
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="w-80 h-80 bg-gradient-to-br from-yellow-100 to-yellow-200 rounded-lg flex items-center justify-center">
                <span className="text-zul-grey-dark text-lg">Cementing Additives Image</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 rounded-lg p-6 text-center">
              ...
              <p className="text-zul-grey-dark text-sm">Advanced cementing solutions for drilling operations</p>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-6 text-center">
              ...
              <p className="text-zul-grey-dark text-sm">Comprehensive cementing support and expertise</p>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-6 text-center">
              ...
              <p className="text-zul-grey-dark text-sm">Well integrity and production optimization</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="font-body text-zul-grey-dark mb-6 leading-relaxed">
                High-performance cementing additives engineered to ensure optimal well integrity, 
                prevent gas migration, and provide long-term zonal isolation. Our formulations 
                deliver superior strength and durability in challenging downhole conditions.
              </p>
              
              <div className="space-y-4">
                <div className="flex items-start">
                  <div className="w-2 h-2 bg-zul-yellow rounded-full mt-2 mr-3"></div>
                  <p className="text-zul-grey-dark">Enhanced compressive strength development</p>
                </div>
                <div className="flex items-start">
                  <div className="w-2 h-2 bg-zul-yellow rounded-full mt-2 mr-3"></div>
                  <p className="text-zul-grey-dark">Superior gas migration control</p>
                </div>
                <div className="flex items-start">
                  <div className="w-2 h-2 bg-zul-yellow rounded-full mt-2 mr-3"></div>
                  <p className="text-zul-grey-dark">Excellent zonal isolation properties</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg p-8 shadow-lg">
              ...
              <div className="space-y-4">
                <div className="flex justify-between border-b border-gray-200 pb-2">
                  <span className="font-medium text-zul-grey-dark">Compressive Strength</span>
                  <span className="text-zul-black">2,500 - 5,000 psi</span>
                </div>
                <div className="flex justify-between border-b border-gray-200 pb-2">
                  <span className="font-medium text-zul-grey-dark">Thickening Time</span>
                  <span className="text-zul-black">3 - 6 hours</span>
                </div>
                <div className="flex justify-between border-b border-gray-200 pb-2">
                ...
                <div className="flex justify-between">
                  <span className="font-medium text-zul-grey-dark">Fluid Loss</span>
                  <span className="text-zul-black">&lt; 50 ml/30min</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-zul-grey-dark text-sm">Primary and remedial cementing</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-zul-grey-dark text-sm">Deepwater cementing operations</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-zul-grey-dark text-sm">Extended reach well cementing</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-zul-grey-dark text-sm">Unconventional well cementing</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-zul-green">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-headline text-white mb-6">
            Ready to Enhance Your Well Integrity?
          </h2>
          <p className="font-body text-white mb-8 max-w-2xl mx-auto">
            Get expert consultation and customized cementing additives for superior well performance and long-term stability.
          </p>
